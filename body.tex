...
To go from the TF-IFF to probabilities, one has to have event spaces.  In  \cite{ThomasBook} appropriate notation and methodology is introduced is to make this passage for TF-IDF. Here we just use those and change `document' to `feature' where appropriate.  These are as follows:
